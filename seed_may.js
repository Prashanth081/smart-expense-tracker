...
function generateDataForMay(year, month, days) {
...
// Generate for May 2026 up to May 6th
generateDataForMay(2026, 5, 6);
...
db.serialize(() => {
    ...
    stmt.finalize(() => {
        console.log(`Successfully added ${transactions.length} rows for May 2026.`);
        db.close();
    });
});
